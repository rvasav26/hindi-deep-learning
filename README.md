...
Used dataset of 9,000+ handwritten Devanagari characters to develop and train a TensorFlow convolutional neural network (CNN). Applied CNN to two [applications](https://www.youtube.com/watch?v=K-BgNTboKrQ) below:
...
## Links
Video Demo: [https://www.youtube.com/watch?v=B65aY0wFP3U](https://www.youtube.com/watch?v=K-BgNTboKrQ)
